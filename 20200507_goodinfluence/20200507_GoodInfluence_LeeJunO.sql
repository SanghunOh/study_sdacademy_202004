...
FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT* FROM (SELECT * FROM GOOD_STORE) 
                                 AS GS LEFT OUTER JOIN LOCATION ON GS.PROVINCE_ID = LOCATION.PROVINCE_ID) AS T1
